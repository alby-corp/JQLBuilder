...
public partial class DateTimeTests
{
    ...
    public void Should_Parses_Is_Empty()
    {
        ...
        var actual = JqlBuilder.Query
            .Where(f => f.DateTime[CustomFieldName].Is(s => s.Empty))
            .ToString();
    ...
    public void Should_Parses_Is_Null()
    {
        ...
        var actual = JqlBuilder.Query
            .Where(f => f.DateTime[CustomFieldName].Is(s => s.Null))
            .ToString();
    ...
    public void Should_Parses_IsNot_Empty()
    {
        ...
        var actual = JqlBuilder.Query
            .Where(f => f.DateTime[CustomFieldName].IsNot(s => s.Empty))
            .ToString();
    ...
    public void Should_Parses_IsNot_Null()
    {
        ...
        var actual = JqlBuilder.Query
            .Where(f => f.DateTime[CustomFieldName].IsNot(s => s.Null))
            .ToString();
